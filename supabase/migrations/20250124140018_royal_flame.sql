/*
  # Create properties view with pictures

  1. Creates a view that transforms real estate data into the format needed by the frontend
  2. Properly joins with the pictures table for image URLs
  3. Adds security policies and permissions
*/
